...
import com.sparrow.sparrow.config.oauth.dto.OAuthAttributes;
import com.sparrow.sparrow.config.oauth.dto.SessionUser;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        // OAuth2 로그인 진행 시 키가 되는 필드값을 이야기한다. PrimaryKey와 같은 의미.
        ...
        // SessionUser는  세션에 사용자 정보를 저장하기 위한 Dto클래스이다.
